export const ResType = {
    ...
    KSGeneralCallbackResult: {
        code: 'number',
        msg: 'string',
    },
    CheckCommonUseSuccessCallbackResult:{
        code: 'number',
        msg: 'string',
        isCommonUse: 'bool'
    },
    CheckShortcutSuccessCallbackResult: {
        code: 'number',
        installed: 'bool',
    },
    CheckSliderBarIsAvailableSuccessCallbackResult: {
        available: 'bool',
    },
    CheckFollowStateCallbackResult: {
        errorCode: 'number',
        errorMsg: 'string',
        hasFollow: 'bool',
    },
    OpenUserProfileCallbackResult: {
        errorCode: 'number',
        errorMsg: 'string',
    },
    ...
    AuthorizeOptionSuccessCallbackResult:{
        code: 'string',
        result: 'number',
    },
    MediaSource: {
